...
@section('admin')
 ...
 <div class="page-content">
    ...
    <a href="{{ route('customer.add') }}" class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;">新增客戶</a> <br>  <br>

                    <h4 class="card-title">所有客戶資料</h4>
