...
@section('admin')
 ...
 <div class="page-content">
    ...
    <a href="{{ route('stock.report.pdf') }}" class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;"><i class="fa fa-print">庫存報告影印</i></a> <br>  <br>

                    <h4 class="card-title">庫存報告</h4>
