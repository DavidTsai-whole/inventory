                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">新增發票</h4><br><br>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-1">
                                    <div class="md-3">
                                        <label for="example-text-input" class="form-label">發票編號</label>
                                ...
                                <div class="col-md-2">
                                    <div class="md-3">
                                        <label for="example-text-input" class="form-label">日期</label>
                                ...
                                <div class="col-md-3">
                                    <div class="md-3">
                                        <label for="example-text-input" class="form-label">分類名稱</label>
                                        <select name="category_id" id="category_id" class="form-select select2"
                                            aria-label="Default select example">
                                            <option selected="" value="" disabled>---選擇---</option>
                                ...
                                <div class="col-md-3">
                                    <div class="md-3">
                                        <label for="example-text-input" class="form-label">產品名稱</label>
                                ...
                                <div class="col-md-1">
                                    <div class="md-3">
                                        <label for="example-text-input" class="form-label">庫存</label>
                                ...
                                <div class="col-md-2">
                                    <div class="md-3">
                                        ...
                                        <i
                                            class="btn btn-secondary btn-rounded waves-effect waves-light fas fa-plus-circle addeventmore">新增</i>
                                    </div>
                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="discount_amount" id="discount_amount"
                                                    class="form-control estimated_amount" placeholder="折扣金額">
                                            </td>
                                        </tr>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-3">
                                        ...
                                        <select name="paid_status" id="paid_status" class="form-select">
                                            ...
                                            <option value="full_paid">全額支付</option>
                                            <option value="full_due">剩餘金額 </option>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-info" id="storeButton">儲存</button>
