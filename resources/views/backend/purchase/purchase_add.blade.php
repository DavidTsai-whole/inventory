                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">新增購買清單</h4><br><br>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="md-3">
                                        <label for="example-text-input" class="form-label">購買編號</label>
                                ...
                                <div class="col-md-4">
                                    <div class="md-3">
                                        <label for="example-text-input" class="form-label">供應商名稱</label>
                                ...
                                <div class="col-md-4">
                                    <div class="md-3">
                                        ...
                                        <i
                                            class="btn btn-secondary btn-rounded waves-effect waves-light fas fa-plus-circle addeventmore">增加</i>
                                    </div>
                                </div>
                ...
                $(document).on('change', '#supplier_id', function() {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            var html = '<option value="" selected disabled>---選擇---</option>';
